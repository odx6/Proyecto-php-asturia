                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" id="PCRXLIT" name="PCRXLIT" placeholder="precio : ">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="" class="col-form-label">N°Litros : </label>
                                    <input type="text" required class="form-control" id="LTS" name="LTS" placeholder="litros : ">
                                </div>
                            </div>
                        </div>
                        <div class="row">
