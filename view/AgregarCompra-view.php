...
if (in_array(1, $_SESSION['Habilidad']['compras'])) {
?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="fas fa-dolly"></i> Agregar Compra</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                            <li class="breadcrumb-item active">Agregar Compras</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                if (isset($resultado) && $resultado != NULL &&  mysqli_num_rows($resultado) > 0) {
                                    ...
                                    while ($fila = mysqli_fetch_assoc($resultado)) {
                                        echo '<option value="' . $fila['pk_prov'] . '"  <?php if($pk_prov= $fila["pk_prov"]) selected ?>   ' . $fila['STRNOM'] . '</option>';
                                    }
                                } else {
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" id="STREMI" name="STREMI" placeholder="remision: ">
                                <span id="STREMI"></span>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="STRFACTURA" name="STRFACTURA" placeholder="Factura: ">
                                <span id="STREMI"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" data-target="#datetimepicker4" id="DTHORFAC" name="DTHORFAG" />
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="datetimepicker3" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" data-target="#datetimepicker3" id="DTHORPAG" name="DTHORPAG" />
    ...
    <script>
        $("#new_register").submit(function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "view/ajax/agregar/agregar_compra.php",
            ...
            var datos='<div class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert">&times;</button> <strong>Error! No se puede crear una compra  sin productos </strong></div>';
                $(".resultados_ajax").html(datos);
        }
