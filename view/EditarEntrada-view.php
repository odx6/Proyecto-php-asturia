...
if (in_array(2, $_SESSION['Habilidad']['Entradas'])) {
            ...
            function Agregar(sku, precio, des, iduni) {
                ...
                if (duplicado) {
                    ...
                    table.row.add([
                        ...
                        '<button class="btn btn-danger btn-square btn-xs"  onclick="DeleteTable(' + indice2 + ' ,\'' + sku + '\')"><i class="far fa-trash-alt"></i></button> ',
                    ]).draw(false);
                    ...
                    success: function(data) {
                        ...
                        inventarioUpdate.forEach(function(Elemento, indice) {
                            ...
                            table.row.add([
                                ...
                                '<button class="btn btn-danger btn-square btn-xs"  onclick="DeleteTable(' + indice + ')"><i class="far fa-trash-alt"></i></button> ',
                            ]).draw(false);
