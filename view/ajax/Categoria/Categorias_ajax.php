...
if ($_SESSION['categorias'] == 1) {
	if (isset($_REQUEST["id"])) { //codigo para eliminar 
		...
		$sqldelete = "SELECT * from tblcatcat WHERE INTIDCAT='$id';";
						...
						<tr>
							...
							<td class="text-right">
								<?php if (in_array(2, $_SESSION['Habilidad']['Categorias'])) { ?>
									<button type="button" class="btn btn-warning btn-square btn-xs" data-toggle="modal" data-target="#modal_update" onclick="editar('<?php echo $INTIDCAT; ?>');"><i class="far fa-edit"></i></button>
								<?php } ?>
